...
function NumberType(rules) {
  NumberType.super_.call(this, rules);
}

util.inherits(NumberType, Type);

eval('NumberType.prototype.validate = ' + NumberType.prototype.validate.toString());
// utils.copyPrototype(Type.prototype, NumberType.prototype);
